...
from Organisms.Postprocessing_Programs.make_energy_vs_similarity_results_Main_Programs.data_from_genetic_algorithm_methods import get_CNA_Profile, get_similarity_value_for_half
def get_similarity_data(path_to_ga_trial,cluster_to_compare_against,rCut,calculator,similarity_data_filename,no_issues=False,start_from=1):
	if no_issues:
		return
	cluster_to_compare_against_CNA_profile = get_CNA_Profile(cluster_to_compare_against,rCut)
	# compare the clusters in the database to the cluster to compare against
